<table style="padding:0;margin:0"><tr style="padding:0;margin:0">
<td class='lefthalf' style="padding:0;margin:0">
	<img src="https://www.moodcaster.com/font-to-image.php?s={{firstLineSize}}&t={{firstLineText}}" />
	<br />
