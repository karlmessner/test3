...
$body=file_get_contents("template-download2.htm");
...
$nGetVar = $n;
$DOMAIN = $_ENV['DOMAIN'];
$variablesToInject = array("stylesheet","Name","Role","Title","Profile_pic","fontSize","lineHeight","shareLink","downloadLink","m4vPath","sGetVar","nGetVar","DOMAIN");
